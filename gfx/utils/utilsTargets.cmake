...
target_compile_options(arg_parser PUBLIC # std::unary_function removed in C++17
...
target_sources(utils_logger_stub
               PRIVATE ${CMAKE_CURRENT_LIST_DIR}/logger_stub.cpp)

target_include_directories(utils_logger_stub
...
ignore_gfx_target(app_utils_demuxer_c clang-tidy warnings)

target_link_libraries(app_utils_demuxer_c ffmpeg::libavcodec
                      ffmpeg::libavformat)
...
target_link_libraries(app_utils_demuxer_cpp ffmpeg::libavcodec
                      ffmpeg::libavformat fmt::fmt)
